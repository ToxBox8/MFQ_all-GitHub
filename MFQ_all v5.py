...
##################################################################################################### 
    ...
    def ondas():
        ...
        def longitud_de_onda():
            v = float(input("\nIngrese la velocidad de propagacion en m/s: "))
            f = float(input("Ingrese la frecuencia en Hz: "))
            lg = v/f
            print("La longitud de onda es",lg,"metros")
        
        def velocidad():
            lg = float(input("\nIngrese la longitud de onda en metros: "))
            f = float(input("Ingrese la frecuencia de propagación de la onda: "))
            v = f*lg
            print("La velocidad de propagación de la onda es",v,"m/s: ")
        
        def frecuencia():
            lg = float(input("\nIngrese la longitud de onda en metros: "))
            v = float(input("Ingrese la velocidad de propagacion en m/s: "))
            f = v/lg
            print("La frecuencia de propagación de la onda es",f,"Hz")
        ondas_main()
    ...
    def  main_fyq():
        print(
            ...
            "\n\t5. Mach            10. Relatividad especial  15. Fuerza de rozamiento        20. Ondas"  
            "\n\t                                                                             0. Salir"
            ""
            ""
...
def herramientas():
    ...
    def descargar_videos():
        ...
        print("Recuerda que debes respetar los términos de servicio de YouTube al usar este código. No está permitido descargar videos sin el permiso del propietario del contenido.")
        ...
        video.download(ruta_descargas)
        print("Descarga completa disfruta!\n")

        
        

    def main_herramientas():
        print("\nHas elegido herramientas!"
                "Elige una opcion:"
                "\n\t1.Descargar videos de YouTube (Es necesario una conexion a internet)"
                "\n\t0.Salir"
            
            
            
            )
        main_egir = input("Introduzca el número de la opcion deseada: ")
        if main_egir == "1":
            descargar_videos()
...
def mfmain():
    ...
    def f_m_funciones():
        while True:
            fmfun = input("Hola!"
                    "\nQue quieres Colegio o Herramientas: "
                ).lower()
        
            if fmfun == "herramientas" or fmfun == "h":
                herramientas()
            elif fmfun == "c" or fmfun == "colegio" or fmfun == "fisica y mates":
                fisica_mates()
